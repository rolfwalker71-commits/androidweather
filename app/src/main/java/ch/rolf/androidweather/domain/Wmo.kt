...
private val WMO = mapOf(
    ...
    51 to WmoInfo("Leichter Nieselregen", "rainy_light"),
    53 to WmoInfo("Nieselregen", "rainy_light"),
    55 to WmoInfo("Starker Nieselregen", "rainy"),
    56 to WmoInfo("Leichter Eisniesel", "rainy_light"),
    57 to WmoInfo("Gefrierender Nieselregen", "rainy"),
    61 to WmoInfo("Leichter Regen", "rainy"),
    63 to WmoInfo("Regen", "rainy"),
    65 to WmoInfo("Starker Regen", "rainy_heavy"),
    66 to WmoInfo("Leichter Eisregen", "rainy"),
    67 to WmoInfo("Eisregen", "rainy_heavy"),
    71 to WmoInfo("Leichter Schneefall", "snowy"),
    73 to WmoInfo("Schneefall", "snowy"),
    75 to WmoInfo("Starker Schneefall", "snowflake"),
    77 to WmoInfo("Schneegriesel", "snowy"),
    80 to WmoInfo("Leichte Regenschauer", "rainy"),
    81 to WmoInfo("Regenschauer", "rainy"),
    82 to WmoInfo("Heftige Regenschauer", "rainy_heavy"),
    85 to WmoInfo("Leichte Schneeschauer", "snowy"),
    86 to WmoInfo("Schneeschauer", "snowflake"),
...
fun getWmo(code: Int, isDay: Boolean = true): WmoInfo {
    ...
    val inferred = when {
        ...
        code <= 59 -> WmoInfo("Nieselregen", "rainy_light")
        code <= 69 -> WmoInfo("Regen", "rainy")
        code <= 79 -> WmoInfo("Schnee", "snowy")
        code <= 84 -> WmoInfo("Regenschauer", "rainy")
