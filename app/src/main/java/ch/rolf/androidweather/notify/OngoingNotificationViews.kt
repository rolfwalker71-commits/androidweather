...
internal fun expandedOngoingViews(
    ...
    return RemoteViews(context.packageName, R.layout.notification_ongoing_expanded).apply {
        ...
        setImageViewBitmap(R.id.ongoing_icon, weatherIconBitmap(context, wmo.glyph, onColor))
...
private fun weatherIconBitmap(context: Context, glyph: String, color: Int): Bitmap {
    val size = (52f * context.resources.displayMetrics.density).toInt().coerceAtLeast(48)
